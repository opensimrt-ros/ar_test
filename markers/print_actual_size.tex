...
\fboxsep=20mm%padding thickness
...
\begin{Marker}{TORAX}
    \centering
    \fbox{\includegraphics[width=13cm]{MarkerData_0}}
\end{Marker}
...
\begin{Marker}{UPPERARM}
    \centering
    \fbox{\includegraphics[width=12cm]{MarkerData_2}}
\end{Marker}
...
\begin{Marker}{FOREARM}
    \centering
    \fbox{\includegraphics[width=8cm]{MarkerData_6}}
\end{Marker}
